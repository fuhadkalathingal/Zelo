                ...
                <div className="p-4 max-w-7xl mx-auto w-full flex flex-col lg:flex-row gap-8">
                    ...
                    <div className="flex-1 space-y-4">
                        ...
                        <div className="bg-white border text-center border-orange-100 rounded-2xl shadow-[0_4px_16px_rgba(0,0,0,0.03)] p-4 flex flex-col gap-3 relative overflow-hidden">
                            ...
                            <a
                                href={`https://wa.me/?text=${encodeURIComponent("Hey! I'm ordering groceries on Zelo. If we order together, we both unlock ₹20 cashback on delivery! Check it out: https://zeloo.netlify.app")}`}
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-full flex items-center justify-center gap-2 border border-orange-200 text-orange-600 font-bold text-xs py-2.5 rounded-xl hover:bg-orange-50 transition-colors shadow-sm mt-3"
                            >
